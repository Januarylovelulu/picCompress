...
public:
    ...
    QString readTextFile(QString fileName=nullptr, QString path=nullptr, char *codec="GB18030");
    ...
    bool writeTextFile(QString text, QString fileName=nullptr, QString path=nullptr, char* codec="GB18030", QIODevice::OpenMode mode=QIODevice::Truncate);
...
#ifdef Q_OS_UNIX
    QVector<int> isExeRunning(QString fileName=nullptr);//判断程序是否在运行，windows下：0为没有运行，其他为在运行；MacOS下：0为没有运行，其他为返回程序的PID
#endif
#ifdef Q_OS_WIN32
